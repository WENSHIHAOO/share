...
class MyTopo(Topo):
    ...
    def build(self):   
        H1=self.addHost('H1', cls=LinuxRouter, ip='170.0.0.1/16')
        R1=self.addHost('R1', cls=LinuxRouter, ip='170.0.0.2/16')
        R2=self.addHost('R2', cls=LinuxRouter, ip='173.0.0.1/16')
        R3=self.addHost('R3', cls=LinuxRouter, ip='174.0.0.1/16')
        R4=self.addHost('R4', cls=LinuxRouter, ip='175.0.0.2/16')
        H2=self.addHost('H2', cls=LinuxRouter, ip='175.0.0.1/16')
